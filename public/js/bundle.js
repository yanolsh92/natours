...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieWFub2xzaCIsImEiOiJjazZqdmJ2aHAwMGI0M29wMWptZjh0eHRhIn0.jyCvNSDIoEZMgiDNn7TUAw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/yanolsh/ck6jvsojz06yo1iuom8z3g3vs',
    scrollZoom: false // center: [-118.1134391, 34.111745],
    // zoom: 10,
    // itteractive: false
...
var stripe = Stripe('pk_test_gImd9bIGMVfoSb0emRamFUAK00tZLV0Bim'); // export const bookTour = async tourId => {
//   try {
